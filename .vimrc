...
set background=dark
colorscheme rose-pine " terminal theme
...
if has("gui_running")
  ...
  set background=dark
  colorscheme rose-pine " gui theme
endif
...
" map <C-k> <cmd>cnext<CR>zz
" map <C-j> <cmd>cprev<CR>zz
" map <leader>k <cmd>lnext<CR>zz
" map <leader>j <cmd>lprev<CR>zz
